function K = calc_k(Ele_Type,Nodes,Elements,C,t,nEle,nNodEle,EleDofs,nDofTot,nDofNod,uGP4,nGP4,wGP4,uGP9,nGP9,wGP9,uGP16,nGP16,wGP16)
...
disp('Stiffness Matrix Progress:')
disp('0%')
...
for iEle = 1:nEle
    ...
    I = meshgrid(EleDofs(iEle,:),EleDofs(iEle,:));
    J = meshgrid(EleDofs(iEle,:),EleDofs(iEle,:));
    I = reshape(I,[],1);
    J = reshape(J',[],1);
    
    Ke = sparse(I,J,Ke,nDofTot,nDofTot);

    K = K + Ke;
    
    if sum(iEle==Percen) == 1
        flag = flag + 10;
