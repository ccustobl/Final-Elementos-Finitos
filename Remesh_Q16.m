...
Elements = zeros(size(Elements_Q4,1)/9,16);
for iLoop = 1:size(Elements_Q4,1)/9
    ...
    Elements(iLoop,[1 5 13 12]) = Elements_Q4(I,:);
    Elements(iLoop,[9 14]) = Elements_Q4(I+1,2:3);
    Elements(iLoop,[2 6]) = Elements_Q4(I+2,2:3);
    Ind([I I+1 I+2],:) = 0;
    
    J = find(Elements_Q4(:,1)==Elements(iLoop,12) & Ind==1,1);
    Elements(iLoop,[16 8]) = Elements_Q4(J,3:4);
    Elements(iLoop,15) = Elements_Q4(J+1,3);
    ...
    case 'Final'
        switch Simetric
            case 'Yes'
                switch Ref_R
                    case 'Yes'
                        save(strcat(['TXT/Half/Elements_Q16_',num2str(TXT_Number),'_r',num2str(Ref_R_Number),'.mat']),'Elements')
                        save(strcat(['TXT/Half/Nodes_Q16_',num2str(TXT_Number),'_r',num2str(Ref_R_Number),'.mat']),'Nodes')
                        disp('Elements and Nodes SAVED')
                    case 'No'
                        save(strcat(['TXT/Half/Elements_Q16_',num2str(TXT_Number),'.mat']),'Elements')
                        save(strcat(['TXT/Half/Nodes_Q16_',num2str(TXT_Number),'.mat']),'Nodes')
                        disp('Elements and Nodes SAVED')
                end
            ...
            case 'No'
                switch Ref_R
                    case 'Yes'
                        save(strcat(['TXT/Full/Elements_Full_Q16_',num2str(TXT_Number),'_r',num2str(Ref_R_Number),'.mat']),'Elements')
                        save(strcat(['TXT/Full/Nodes_Full_Q16_',num2str(TXT_Number),'_r',num2str(Ref_R_Number),'.mat']),'Nodes')
                        disp('Elements and Nodes SAVED')
                    case 'No'
                        save(strcat(['TXT/Full/Elements_Full_Q16_',num2str(TXT_Number),'.mat']),'Elements')
                        save(strcat(['TXT/Full/Nodes_Full_Q16_',num2str(TXT_Number),'.mat']),'Nodes')
                        disp('Elements and Nodes SAVED')
                end
        end
        
    case 'PatchTest'
        save(strcat('TXT/PatchTest/Elements_Q16_PatchTest.mat'),'Elements')
        save(strcat('TXT/PatchTest/Nodes_Q16_PatchTest.mat'),'Nodes')
        
    case 'Plate'
        save(strcat('TXT/Plate/Elements_Plate_Q16.mat'),'Elements')
        save(strcat('TXT/Plate/Nodes_Plate_Q16.mat'),'Nodes')
end
