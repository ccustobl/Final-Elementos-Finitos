...
for i_Data = 1:length(Data)
    eval(strcat(char(Data(i_Data)),'_',Ele_Type,'_',TXT_Number,'_r',Ref_R_Number,'_',Material,'_',num2str(E2/1000),'_',num2str(G12/1000),'=zeros(500,19);'))
    ...
    eval(strcat(char(Data(i_Data)),'_',Ele_Type,'_',TXT_Number,'_',Material,'_',num2str(E2/1000),'_',num2str(G12/1000),'=zeros(500,19);'))
